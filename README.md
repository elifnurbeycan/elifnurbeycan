...
### Computer Engineering Student | Backend & Intelligent Systems | Mobile Games, Growth and Data Curious

I am a Computer Engineering student at Bursa Technical University who enjoys building practical software across backend services, embedded systems, networking and intelligent applications. I am especially interested in how data, experimentation and product thinking can help digital products reach the right users.
...
- Studying Computer Engineering with a strong interest in backend development, data-driven systems, cybersecurity, embedded systems and networking.
- Comfortable working across both software and hardware layers, from REST APIs and databases to ROS2-based robotic systems and BLE/IoT projects.
- Interested in mobile games, user acquisition, campaign performance, A/B testing and how product teams use metrics such as CPI, retention, LTV and ROAS to grow sustainably.
- I enjoy turning complex technical ideas into clear, useful products and collaborating with people from product, data and engineering backgrounds.

---

## What I Bring

**Engineering mindset:** I approach problems by breaking them down, validating assumptions and building reliable systems.

**Data curiosity:** I like working with metrics, structured reporting and experimentation. I am developing my understanding of growth analytics, mobile measurement and performance marketing.

**Product awareness:** My projects often connect technical implementation with user experience, system behavior or measurable outcomes.

**Learning speed:** I am comfortable entering new domains, reading documentation, testing ideas and improving through feedback.
...
- Built game logic around strategy, player actions and learning-based behavior.
...
- Growth, marketing analytics and mobile gaming internships
- Backend development and data-informed product projects
- Collaborative engineering work involving APIs, databases, IoT, robotics or intelligent systems
